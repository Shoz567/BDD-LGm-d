...
async function getProducts(searchParams: SearchParams) {
  ...
  let query = getSupabaseAdmin()
    .from('products')
    .select('id, reference, nom, description, categorie, prix_ttc, base_lppr, image_url', { count: 'exact' })
...
export default async function CataloguePage({ searchParams, basePath = '/catalogue' }: { searchParams: Promise<SearchParams>; basePath?: string }) {
